 ...
 */
 	...
 	function dslc_js_confirm_close() {
 		...
 		jQuery('.dslca-prompt-modal').animate({
			...
			jQuery('.dslca-prompt-modal-confirm-hook').html('<span class="dslc-icon dslc-icon-ok"></span>CONFIRM');
 		});
...
jQuery(document).ready(function($) {
	 ...
	 */
		...
		$(document).on( 'click', '.dslca-import-modules-section-hook', function(e) {
			...
			if ( ! $(this).hasClass('dslca-action-disabled') ) {
				$('.dslca-prompt-modal-confirm-hook').html('<span class="dslc-icon dslc-icon-ok"></span><span>IMPORT</span><div class="dslca-loading followingBallsGWrap"><div class="followingBallsG_1 followingBallsG"></div><div class="followingBallsG_2 followingBallsG"></div><div class="followingBallsG_3 followingBallsG"></div><div class="followingBallsG_4 followingBallsG"></div></div>');
				dslc_js_confirm( 'import_modules_section', '<span class="dslca-prompt-modal-title">Import Row</span><span class="dslca-prompt-modal-descr">Copy the row export code bellow. <br><br><textarea></textarea></span>', $(this) );
			}
		...
		$(document).on( 'click', '.dslca-delete-modules-section-hook', function(e){
			...
			if ( ! $(this).hasClass('dslca-action-disabled') ) {
				dslc_js_confirm( 'delete_modules_section', '<span class="dslca-prompt-modal-title">Delete Row</span><span class="dslca-prompt-modal-descr">Are you sure you want to delete this row?</span>', $(this) );
			}
		...
		$(document).on( 'click', '.dslca-export-modules-section-hook', function(e) {
			...
			if ( ! $(this).hasClass('dslca-action-disabled') ) {
				...
				dslc_js_confirm( 'export_modules_section', '<span class="dslca-prompt-modal-title">Export Row</span><span class="dslca-prompt-modal-descr">The code bellow is the importable code for this row. <br><br><textarea></textarea></span>', $(this) );
	...
	$(document).on( 'click', '.dslca-delete-modules-area-hook', function(e){
		...
		if ( ! $(this).hasClass('dslca-action-disabled') ) {
			dslc_js_confirm( 'delete_modules_area', '<span class="dslca-prompt-modal-title">Delete Area/Column</span><span class="dslca-prompt-modal-descr">Are you sure you want to delete this modules area?</span>', $(this) );
		}
	...
	$(document).on( 'click', '.dslca-delete-module-hook', function(e){
		...
		if ( ! $(this).hasClass('dslca-action-disabled') ) {
			...
			dslc_js_confirm( 'delete_module', '<span class="dslca-prompt-modal-title">Delete Module</span><span class="dslca-prompt-modal-descr">Are you sure you want to delete this module?</span>', $(this) );
...
jQuery(document).ready(function($){
	...
	$(document).on( 'click', '.dslca-wysiwyg-actions-edit-hook', function(){
		...
		if ( module.hasClass('dslc-module-DSLC_Accordion') ) {
			...
			var content = full_content_arr[key_value].trim();
			...
			var content = module.find( '.dslca-module-option-front[data-id="' + editable.data('id') + '"]' ).val();
